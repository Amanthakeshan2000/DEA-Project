 ...
 * @author Dell
 */
@WebServlet(urlPatterns = {"/StaffRegisterServlet"})
...
StaffRegister r2=new StaffRegister();
r2.SRegister(staffID,FirstName,Lname,DOB,gender,nbr,E_mail,Address,country,city,Zip,pws,checkPws2,Grade);
    }
